...
<head>
    ...
    <title>Sysmed | Pesquisa Paciente por nome</title>
...
<body>
    <header class="cabecalho">
        ...
        <nav class="container-menu">
            <ul class="list-menu">
                ...
                <a href="./PesqPacienteNome.php" class="menu-link actual-page"><li class="container-menu-link">Pacientes Pesquisa por nome</li></a>
    ...
    <div class="container-content">
        <p class="page-name">Pesquisa de pacientes por nome</p>
        <form action="./PesqPacienteFilter.php" method="post" class="f_search_name">
                <label for="t_name" class="lbl-data">
                    Nome do paciente <input type="text" name="txt_name" id="t_name" placeholder="" autocomplete="off" class="input-data" required>
                </label>

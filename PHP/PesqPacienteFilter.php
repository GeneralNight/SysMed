...
<?php
    ...
    $nome = $_POST['txt_name'];
    $sql="SELECT * FROM pacientes WHERE Nome LIKE '%$nome%' ORDER BY Nome ASC ";
...
<header class="cabecalho">
    ...
    <p class="page-name">Procura por nome de paciente <button onclick="window.location='./PesqPacienteNome.php'"class="search-other">Procurar outro</button></p>

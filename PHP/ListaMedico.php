...
<head>
    ...
    <title>Sysmed | Lista de Médicos</title>
...
<body>
    <header class="cabecalho">
        ...
        <nav class="container-menu">
            <ul class="list-menu">
                ...
                <a href="./ListaMedico.php" class="menu-link actual-page"><li class="container-menu-link">Médicos - Lista Geral</li></a>
    ...
    <div class="container-content">
        <p class="page-name">Lista geral de médicos</p>

...
<body>
    ...
    <div class="container-content">
        <p class="page-name">Pesquisa de médicos por nome</p>
        <form action="./PesqMedicoFilter.php" method="post" class="f_search_name">
                <label for="t_name" class="lbl-data">
                    Nome do médico <input type="text" name="txt_name" id="t_name" placeholder="" autocomplete="off" class="input-data" required>
                </label>
